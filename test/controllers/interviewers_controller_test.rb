...
class InterviewersControllerTest < ActionController::TestCase
  ...
  test "should create interviewer" do
    assert_difference('Interviewer.count') do
      post :create, interviewer: { interviewercompany: @interviewer.interviewercompany, interviewername: @interviewer.interviewername }
    end
  ...
  test "should update interviewer" do
    patch :update, id: @interviewer, interviewer: { interviewercompany: @interviewer.interviewercompany, interviewername: @interviewer.interviewername }
    assert_redirected_to interviewer_path(assigns(:interviewer))
  end
