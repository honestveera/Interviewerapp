class InterviewerfeedbacksController < ApplicationController
  ...
  private
    ...
    def interviewerfeedback_params
      ...
      :relevanceexperiencecomment,:personalitycomment,:communicationcomment,:technicalskillscomment,:analyticalskillscomment,:jobknowledgecomment,:timemanagementcomment,:commitementtaskcomment,:leadershipcomment,:teamworkcomment,:goalsettingscomment,:creativitycomment,:flexibilitycomment,:assertivenesscomment)
    end
end
