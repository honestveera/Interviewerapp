class CandidatedetailsController < ApplicationController
  ...
  private
    ...
    def candidatedetail_params
      params.require(:candidatedetail).permit(:candidatename, :candidateemail, :candidatecontact, :jobtitle,:primaryskills,:secondaryskills,:otherskills,:primaryskills_id,:secondaryskills_id,:otherskills_id,:attachedfile,:status,:skypeid)
    end
end
